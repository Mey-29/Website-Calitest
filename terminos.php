...
<body>
    ...
    <div class="container">
        ...
        <section>
            <p>Usted está visitando el «Sitio Web o la Aplicación de CALITEST S.A.C.», de titularidad de CALITEST S.A.C., con R.U.C. N°20607832634, con domicilio en Cal. Jangas Nro. 628 Urb. Chacra Colorada, distrito de Breña, provincia de Lima y departamento de Lima.</p>
        </section>
        ...
        <section>
            <h2>LICENCIA</h2>
            <p>CALITEST S.A.C. a través de su sitio web concede una licencia para que los usuarios utilicen los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>
        </section>

        <section>
            <h2>USO NO AUTORIZADO</h2>
            <p>En caso de que aplique (para venta de software, templates, u otro producto de diseño y programación) usted no puede colocar uno de nuestros productos, modificado o sin modificar, en un CD, sitio web o ningún otro medio y ofrecerlos para la redistribución o la reventa de ningún tipo.</p>
        </section>
        ...
        <section>
            ...
            <p>CALITEST S.A.C. reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
        </section>
    </div>
  <button id="botonSubir" onclick="volverArriba()">↑</button>
